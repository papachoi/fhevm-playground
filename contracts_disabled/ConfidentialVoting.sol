 ...
 * @notice Tracks votes for A/B using TFHE.cmux-style branching.
...
contract ConfidentialVoting {
    ...
    function vote(ebool voteForA) external {
        aVotes = TFHE.cmux(voteForA, TFHE.add(aVotes, euint64.wrap(1)), aVotes);
        bVotes = TFHE.cmux(voteForA, bVotes, TFHE.add(bVotes, euint64.wrap(1)));
    }
